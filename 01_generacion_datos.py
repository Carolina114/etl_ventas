...
Original file is located at
    https://colab.research.google.com/drive/1Xk-C4awlpJeoUTdOsi9QtvuuxoBG_8zZ
"""
#Eliminamos la conexion a colab
...
for ruta in [ruta, ruta_dim, ruta_fact]:
...
ruta_dim  = "/content/drive/MyDrive/Ventas_estudia/data_ventas/dimensiones/"
ruta_fact = "/content/drive/MyDrive/Ventas_estudia/data_ventas/hechos/"

dim_clientes   = pd.read_csv(ruta_dim  + "dim_clientes.csv")
dim_productos  = pd.read_csv(ruta_dim  + "dim_productos.csv")
dim_tiendas    = pd.read_csv(ruta_dim  + "dim_tiendas.csv")
dim_vendedores = pd.read_csv(ruta_dim  + "dim_vendedores.csv")
fact_ventas    = pd.read_csv(ruta_fact + "fact_ventas.csv")
fact_envios    = pd.read_csv(ruta_fact + "fact_envios.csv")

print(f"dim_clientes   : {len(dim_clientes)} filas")
print(f"dim_productos  : {len(dim_productos)} filas")
print(f"dim_tiendas    : {len(dim_tiendas)} filas")
print(f"dim_vendedores : {len(dim_vendedores)} filas")
print(f"fact_ventas    : {len(fact_ventas)} filas")
print(f"fact_envios    : {len(fact_envios)} filas")
...
# ID de tu carpeta en Drive (lo sacas de la URL de tu carpeta)
FOLDER_ID = "1T3w-o4CjGnRncs0bl37FDNy-9-1baaYJ"

# Sube todos los CSVs generados
